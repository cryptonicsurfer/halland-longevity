...
export function ScienceSection() {
  return (
    <section id="science" className="py-24 bg-gradient-to-b from-cyan-900 via-cyan-950 to-cyan-950 text-white overflow-hidden relative">
      {/* Abstract background elements */}
      <div className="absolute top-0 right-0 w-1/2 h-full bg-cyan-800/15 transform skew-x-12" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          {/* Pillar 1: The Data */}
          <div className="bg-cyan-900/50 backdrop-blur-sm p-8 rounded-2xl border border-cyan-800 hover:border-cyan-500/50 transition-colors group">
